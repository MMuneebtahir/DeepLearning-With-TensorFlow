...
- [Should you do this course?](https://github.com/mrdbourke/tensorflow-deep-learning#should-you-do-this-course) (decide by answering a couple of simple questions)
...
* **Exercises & Extra-curriculum:** Each module comes with a set of exercises and extra-curriculum to help practice your skills and learn more, I suggest going through these **before** you move on to the next module
...
This means we write code first and then step through the concepts behind it.

If you've got 6-months of experience writing Python code and a willingness to learn (most importantly), you'll be able to do the course.

## Should you do this course?

> Do you have 1+ years of experience with deep learning and writing TensorFlow code?
...
If not, go and do a beginner machine learning course and if you decide you want to learn TensorFlow, this page will still be here.
...
You can find solutions to the exercises in [`extras/solutions/`](https://github.com/mrdbourke/tensorflow-deep-learning/tree/main/extras/solutions), there's a notebook per set of exercises (one for 00, 01, 02... etc).
...
* To practice your regression modeling with TensorFlow, I'd also encourage you to look through [Kaggle's datasets](https://www.kaggle.com/data), find a regression dataset that sparks your interest and try to model.
...
* Read the [ML-Glossary documentation on activation functions](https://ml-cheatsheet.readthedocs.io/en/latest/activation_functions.html). Which one is your favorite?
...
2. Get the most up-to-date data on Bitcoin, train a model & see how it goes (our data goes up to May 18, 2021).
  * You can download the Bitcoin historical data for free from [coindesk.com/price/bitcoin](https://www.coindesk.com/price/bitcoin) and click "Export Data" -> "CSV".
...
* [Forecasting: Principles and Practice](https://otexts.com/fpp3/) is an outstanding online textbook that discusses at length many of the most important concepts in time series forecasting. I'd especially recommend reading at least Chapter 1 in full.
...
Jordan Kern, watching these will take you from 0 to 1 with time series problems: 
  ...
  * [Time Series Modelling](https://www.youtube.com/watch?v=s3XH7fTHMb4) - different techniques for modeling time series data (many of which aren't deep learning).
...
2. Go through the Skills Checklist section of the TensorFlow Developer Certification Candidate Handbook and create a notebook that covers all of the skills required, write code for each of these (this notebook can be used as a point of reference during the exam).
...
3. After going through (2), go into PyCharm and make sure you can train a model in TensorFlow. The model and dataset in the example `image_classification_test.py` [script on GitHub](https://github.com/mrdbourke/tensorflow-deep-learning/blob/main/extras/image_classification_test.py) should be enough. If you can train and save the model in under 5-10 minutes, your computer will be powerful enough to train the models in the exam.
    - Make sure you've got experience running models locally in PyCharm before taking the exam. Google Colab (what we used throughout the course) is a little different from PyCharm.
...
* Multi-modal models (models that use more than one data source such as text & images)
